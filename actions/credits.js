...
//this user object is provided from header by calling this function
export async function checkAndAllocateCredits(user) {
    try {
        ...
        //Only allocate credits for User
        if (user.role !== "USER") {
            return user;
        }

        //ye clerk ka hai sab cheez this is used to check the user plan and uske hisab se credits allocate karne ke liye
